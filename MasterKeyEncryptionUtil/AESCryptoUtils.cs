...
namespace ATS.Utilities
{
    ...
    {
        private static int RSA_SIZE = 32;
        private static int RSA_IV_SIZE = 16;
        //private static byte[] RSA_KEY = new byte[] { 48, 130, 9, 4, 22, 1, 0, 2, 130, 2, 1, 0, 201, 145, 168, 68, 166, 207, 248, 229, 241, 251, 66, 124, 185, 139, 221, 203, 54, 246, 37, 184 };
        //private static byte[] RSA_IV = new byte[] { 166, 207, 248, 229, 241, 251, 66, 124, 185, 139, 221, 203, 54, 246, 37, 184 };
