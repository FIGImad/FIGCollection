...
namespace FIGPriceSyncSvc
{
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            {
                c.ServiceName = ResolveWindowsServiceName(args, "FIGPriceSyncSvc");
            });
            #endregion WindowsServiceURLS

            #region Configuration
            string settingsFilename = "price-sync-settings";
            ...
            // Add the PriceChangeMonitorService as a hosted service
