using FIGAutoTradeExSvc.Middleware;
...
namespace FIGAutoTradeExSvc
{
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            {
                c.ServiceName = ResolveWindowsServiceName(args, "FIGAutoTraderSvc");
            });
            #endregion WindowsServiceURLS

            #region Configuration
            string settingsFilename = "autotrade-settings";
            ...
            // 
            builder.Services.AddHttpClient(nameof(FigBrokerAPIService)).ConfigurePrimaryHttpMessageHandler(CreateIgnoreNameMismatchHandler);
            ...
            // Create AutoTradeManagementService (Main Auto-Trade Management Service)
            // Create one singleton instance of AutoTradeManagementService
            builder.Services.AddSingleton<IAutoTradeManagementService, AutoTradeManagementService>();
            // Reuse the same instance and Add it to the IHostedService pipeline.
            builder.Services.AddHostedService(sp => sp.GetRequiredService<IAutoTradeManagementService>());

            // Create OrderManagementService (Main Order Management Service)
            // Create one singleton instance of OrderManagementService
