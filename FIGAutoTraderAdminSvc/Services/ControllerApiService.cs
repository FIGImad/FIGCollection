...
namespace FIGAutoTraderAdminSvc.Services
{
    public class ControllerApiService : ApiServiceBase
    {
        ...
        public async Task<List<DeviceRS>?> GetDeviceList(int timeout = 10000, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<PongDto?> Ping(string serviceId, int timeout, CancellationToken cancellationToken = default)
        {
            var req = new ControllerRouteRequest();
